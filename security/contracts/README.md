...
7. creates and freezes an immutable `GenesisReceipt` recording the recipient, decimals, and exact genesis supply;
8. transfers the complete initial supply to the publisher for approved treasury/allocation operations.
